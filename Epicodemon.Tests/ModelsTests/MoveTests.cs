...
namespace Epicodemon.Tests
{
  ...
  public class MoveTests : IDisposable
  {
    ...
    public void Save_GetAllMoves_Test()
    {
      ...
      Move newMove1 = new Move("flamethrower", 95, "special", "flamey boi", "brn 10", 15);
      newMove.Save();
      newMove1.Save();
    ...
    {
      //Arrange
      Move newMove = new Move("ice beam", 95, "special", "icy boi", "frz 10", 15);
      newMove.Save();
    ...
    {
      //Arrange
      Move newMove = new Move("psycic", 95, "special", "telekenetic boi", "spdef 10", 15);
      newMove.Save();
      Move expectedMove = new Move("psychic", 95, "special", "telekenetic boi", "spdef 10", 15, newMove.GetMoveId());
      //Act
      newMove.Edit("psychic", 95, "special", "telekenetic boi", "spdef 10", 15);
    ...
    {
      //Arrange
      Move newMove = new Move("tackle", 35, "physical", "tackly boi", "none", 35);
      newMove.Save();
      Move newMove1 = new Move("scratch", 35, "physical", "scratchy boi", "none", 45);
      newMove1.Save();
